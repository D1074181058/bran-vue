...
class signupform(forms.Form):
    Name = forms.CharField(min_length=2,max_length=10, initial='',widget=forms.TextInput(attrs={'placeholder': '吳宗翰','autocomplete':'off'}))
    account = forms.CharField(max_length=10,initial='',widget=forms.TextInput(attrs={'autocomplete':'off'}))
    password = forms.CharField(max_length=20,initial='',widget=forms.PasswordInput(attrs={'autocomplete':'off'}))
    email = forms.EmailField(max_length=100,initial='',widget=forms.TextInput(attrs={'autocomplete':'off',}))
